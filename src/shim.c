...
int shim_do_pread64(int fd, void *buf, size_t count, off_t off, ssize_t *result)
{
	ssize_t ret = 0;
		...
		long arg4, long arg5, long *result)
{
	...
	case SYS_creat:
		return shim_do_create((char *)arg0, (mode_t)arg1,
				      (int *)result);
	case SYS_read:
	...
	case SYS_lseek:
		return shim_do_lseek((int)arg0, (off_t)arg1, (int)arg2,
				     (off_t *)result);
	case SYS_mkdir:
		return shim_do_mkdir((const char *)arg0, (mode_t)arg1,
				     (int *)result);
	case SYS_rmdir:
